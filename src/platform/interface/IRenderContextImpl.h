...
public:
     ...
     */
    virtual void DrawArrays(PrimitiveType primitiveType, uint32_t vertexStart, uint32_t vertexCount) = 0;
     ...
     */
    virtual void DrawElements(PrimitiveType primitiveType, uint32_t indexCount, 
                             IndexType indexType, size_t indexOffset) = 0;
    
    /**
     * @brief 实例化绘制
     */
    virtual void DrawArraysInstanced(PrimitiveType primitiveType, uint32_t vertexStart, 
                                    uint32_t vertexCount, uint32_t instanceCount) = 0;
    
    /**
     * @brief 实例化索引绘制
     */
    virtual void DrawElementsInstanced(PrimitiveType primitiveType, uint32_t indexCount,
