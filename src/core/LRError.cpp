...
ErrorCode LRError::GetLastError() {
    return s_lastError.code;
}

const ErrorInfo& LRError::GetLastErrorInfo() {
    return s_lastError;
}

void LRError::ClearError() {
    s_lastError = ErrorInfo{};
}
...
bool LRError::HasError() {
    return s_lastError.code != ErrorCode::Success;
}
